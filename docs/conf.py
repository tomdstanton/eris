...
project = eris.__name__
author = re.match('(.*) <.*>', eris.__author__).group(1)
year = datetime.date.today().year
copyright = '{}, {}'.format("2022" if year==2022 else "2022-{}".format(year), author)

# extract the semantic version
semver = semantic_version.Version.coerce(eris.__version__)
...
doc_lines = eris.__doc__.splitlines()
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/klebgenomics/eris",
            "icon": "fa-brands fa-github",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/eris",
    ...
    "switcher": {
        "json_url": "https://eris.readthedocs.io/en/latest/_static/switcher.json",
        "version_match": version,
    }
}

html_context = {
    "github_user": "klebgenomics",
    "github_repo": "eris",
    "github_version": "main",
    "doc_path": "docs",
}
...
htmlhelp_basename = eris.__name__
